export class Grid {
    ...
    draw(shaderProgram) {
        ...
        this.webgl.bufferData(this.webgl.ARRAY_BUFFER, this.gridVertices, this.webgl.STATIC_DRAW);
        let vertexPositionAttrribute  = this.webgl.getAttribLocation(shaderProgram, "aVertexPosition");
